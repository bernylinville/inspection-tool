    ...
    <a-spin :spinning="loading">
      <div v-if="instance" class="space-y-6">
        ...
        <a-descriptions title="版本信息" :column="1" bordered>
          ...
          <a-descriptions-item label="JVM版本">{{ instance.jvm_version || '-' }}</a-descriptions-item>
        </a-descriptions>
      ...
      <div v-else class="py-8 text-center text-sm text-gray-500">暂无 Tomcat 详情</div>
    </a-spin>
  </a-drawer>
</template>
