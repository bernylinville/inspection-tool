...
func NewNginxAlert(identifier, metricName string, currentValue float64, level pkgmodel.AlertLevel) *NginxAlert {
	return &NginxAlert{
...
func (r *NginxInspectionResult) AddAlert(alert *NginxAlert) {
	...
	} else if alert.Level == pkgmodel.AlertLevelWarning && r.Status != NginxStatusCritical {
