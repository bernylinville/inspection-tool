...
type TomcatAlert struct {
	...
	Level             pkgmodel.AlertLevel `json:"level"`
	Message           string     `json:"message"`
}

func NewTomcatAlert(identifier, metricName string, currentValue float64, level pkgmodel.AlertLevel) *TomcatAlert {
	return &TomcatAlert{
...
func (a *TomcatAlert) IsWarning() bool {
	return a != nil && a.Level == pkgmodel.AlertLevelWarning
}

func (a *TomcatAlert) IsCritical() bool {
	return a != nil && a.Level == pkgmodel.AlertLevelCritical
}
